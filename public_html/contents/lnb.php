...
?>
	...
	<div class="area_lnb">
		<div class="inr">
			...
			<!-- lnb -->
			<nav class="lnb">
				<? print_lnb($connect, "pc", $row_[ref_group], $depth_history[0], 2, 2); ?>
			</nav>
			<!-- //lnb -->
			
			<!-- snb -->
			<div class="snb">
				<? print_lnb($connect, "pc", $row_[ref_group], $depth_history[1], 3, 3); ?>
	...
	<div class="area_tab">
			<? print_lnb($connect, "pc", $row_[ref_group], $depth_history[2], 4, 4); ?>
	</div>