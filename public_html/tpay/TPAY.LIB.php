...
class Encryptor{
	...
	function encrypt ($key, $iv, $value){
			...
			$output = openssl_encrypt($value, 'AES-128-CBC', $key, OPENSSL_RAW_DATA | OPENSSL_NO_PADDING, $iv);
	...
	function decrypt ($key, $iv, $value){
			...
			$output = openssl_decrypt($value, 'AES-128-CBC', $key, OPENSSL_RAW_DATA | OPENSSL_NO_PADDING, $iv);
