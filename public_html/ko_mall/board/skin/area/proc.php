...
if($mode == "modify"){
	...
	/*mysqli_query("INSERT INTO $board_id VALUES ('', '$depth', '$ref_no', '$check_[ref_group]', '$_SESSION[member_id]', '$_SESSION[CI]', '$_SESSION[DI]', '$name', '$password', '$phone','$email', '$zip', '$address1', '$address2', '$category', '$title', '$comments_type','$tag_type
